...
lblinfo = Label(Tops, font=( 'Monotype Corsiva' ,16, 'bold' ),text=" <<  Welcome! Please make your order by viewing the price list  >> ",fg="red",bg="#FFFF72",bd=12,anchor='w')
...
txtreference = Entry(f1,font=('ariel' ,14,'bold'), textvariable=rand , bd=6,insertwidth=4,bg="light pink" ,justify='right')
...
txtcost = Entry(f1,font=('arial' ,14,'bold'), textvariable=cost , bd=6,insertwidth=4,bg="light pink" ,justify='right')
...
txtTax = Entry(f1,font=('arial' ,14,'bold'), textvariable=Tax , bd=6,insertwidth=4,bg="light pink" ,justify='right')
txtTax.grid(row=3,column=3)

lblSubtotal = Label(f1, font=( 'Engravers MT' ,14, 'bold' ),text="Subtotal",fg="maroon",bd=10,anchor='w')
lblSubtotal.grid(row=4,column=2)
txtSubtotal = Entry(f1,font=('arial' ,14,'bold'), textvariable=Subtotal , bd=6,insertwidth=4,bg="light pink" ,justify='right')
txtSubtotal.grid(row=4,column=3)

lblTotal = Label(f1, font=( 'Engravers MT' ,14, 'bold' ),text="Total",fg="maroon",bd=10,anchor='w')
lblTotal.grid(row=5,column=2)
txtTotal = Entry(f1,font=('arial' ,14,'bold'), textvariable=Total , bd=6,insertwidth=4,bg="light pink" ,justify='right')
